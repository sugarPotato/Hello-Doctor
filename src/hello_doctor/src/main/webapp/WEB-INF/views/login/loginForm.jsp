            ...
            <ul>
               ...
               <div class="info">
                  <li>
                     ...
                     <input type="text" placeholder="아이디" value="" name="dId">
                  </li>
                  <li>
               ...
               <li>
                  <h3>
                  <a onclick="window.open('http://localhost/ddit/findid/','window_name','width=550,height=500');" ><small>아이디/비밀번호 찾기</small>

...
<div class="card-tools" style="margin-left: 13%;">
					...
					<div class="card-body pad">
						<form role="form" method="post" action="regist.do"
							...
							<div class="col-md-6" style="display: contents;">
								<div class="form-group" style="width: 300px; display: contents;">
									<i class="fa fa-calendar" style="margin-left: 3.5%;"></i> <label
										for="date"></label>
										<input class="datepicker" type="text"  placeholder="       2022-07-05" id="title" name="title" class="form-control"
								...
								<div class="col-md-6" style="display: contents;">
									<div class="input-group-prepend"
										...
										<select class="form-control"
											...
											<option selected value="외래진료">외래 진료</option>
							...
							<div class="form-group">
								<div class="col-md-6" style="display: contents;">
									<label for="title" style="margin-left: 3px;">담당자</label>
									<input type="text" class="form-control"  disabled placeholder="       박태정"   style="width: 151px;display: inline;margin-left: 27px;"/>
								</div>
								<div class="col-md-6" style="display: contents;">
							...
							<div class="form-group">
								...
								<i style="font-size: 2.0em;"class="fa fa-pencil-square-o"></i>
								</div>
							</div>
							<div class="form-group">
								...
								<input type="text" placeholder="CHEST-PA" id="title" name="title" class="form-control"
									style="display: inline; width: 40%; margin-left: -2px;">
								<i class="fa fa-calendar" style="margin-left: 2.5%;"></i>
								<input class="datepicker" type="text" placeholder="   2022-07-02" id="title" name="title" class="form-control"
						...
						<div class="form-group">
								...
								<input type="text" placeholder="CHEST-PA" id="title" name="title" class="form-control"
									style="display: inline; width: 40%; margin-left: -2px;">
								<i class="fa fa-calendar" style="margin-left: 2.5%;"></i>
								<input class="datepicker" type="text" placeholder="   2022-07-04" id="title" name="title" class="form-control"
									style="display: inline; height: 31px;width: 184px; margin-left: 18px;"><a href="#"
									style="display: inline; margin-left: 11px; font-size: 23px; vertical-align: -4px;">  <i class="fa fa-minus" style="color: red"></i></a>
							</div>

	...
	<section style="padding: 0px;" class="content container-fluid">
			...
			<div class="col-md-13" style="padding: 3px">
				<div class="card card-outline card-info">
					<div class="card-header row" style="margin-right: 0px; margin-left: 0px;" >
						<h4 style="width: 200px;" class="col-md-8">예약 수정 상세보기
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<h3 class="font-bold" style="padding-left:25px; padding-top: 20px"><i class="fa fa-pencil-square-o"></i>&nbsp;의료행위 수정 반려사유를 기재해주세요</h3>
...
<div class="form-group" style="display:inline;">
    ...
    margin-left: 11px;">
							...
							<div class="form-group">
								<div class="col-md-6">
									<label for="title" style="margin-left: -15px;">수정 사유</label>
								</div>
								<div class="col-md-6" style="display: contents;">
									<textarea  id="title" name="title_disease" readonly disabled
										class="form-control" placeholder="해당환자 낙상사고로 해당 검사 필요합니다"
										style="width: 84%; display: inline; margin-left: 70px; height: 100px; margin-top: -26px;"></textarea>

			...
			<div class="row">
				<c:forEach items="${myCooperationList}" var="myCooperation">
					<div class="col-lg-4" style="padding-left: 22px;">
						<div class="contact-box demo3" style="box-shadow: 1px 1px 1px 1px darkkhaki;" onclick="cooperationDetail('${myCooperation.coRelease}')">
							<div class="col-8">
								<h3>

									<strong>협진시작일&nbsp;&nbsp;${myCooperation.coStartDate}</strong>&emsp;&emsp;&emsp;&emsp;
								...
								<p>${myCooperation.coDisease}| ${myCooperation.pName}</p>

			...
			<div class="row">
				<c:forEach items="${myCooperation_proceeding}" var="myCooperation_proceeding">
					<div class="col-lg-4" style="padding-left: 22px;">
						<div class="contact-box demo3" style="box-shadow: 1px 1px 1px 1px #000;" onclick="cooperationDetail('${myCooperation_proceeding.coRelease}')">
							<div class="col-8">
								<h3>
									<strong>협진시작일&nbsp;&nbsp;${myCooperation_proceeding.coStartDate}</strong>&emsp;&emsp;&emsp;&emsp;
								...
								<p>${myCooperation_proceeding.coDisease} | ${myCooperation_proceeding.pName}</p>

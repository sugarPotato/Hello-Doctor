...
<link href="<%=request.getContextPath()%>/resources/css/plugins/jsTree/style.min.css" rel="stylesheet">

<link href="<%=request.getContextPath()%>/resources/css/chart.css" rel="stylesheet">
...
<body>
		...
		<div id="page-wrapper" class="gray-bg" style="width: 1100px;">
			<div class="header">
				...
				<div class="displayinline floatright padding10">
					<a class="" type="submit" onclick="window.close();">
						<i class="fa fa-window-close-o" aria-hidden="true" style="font-size: 29px;"></i>
					</a>
				</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight"
							...
							<div class="contact-box-footer">
								<div class="m-t-xs btn-group">
									<a href="" class="btn btn-xs btn-white"><i
										class="fa fa-share-alt"></i> 공유하기 </a>
								</div>
							</div>
				...
				<div class="displayinline padding10" style="margin-top: -16px;">
					<h3>공유할 의사 목록</h3>
				</div>
				<hr style="margin-top: -5px;">
	...
	<script src="<%=request.getContextPath()%>/resources/js/plugins/jsTree/jstree.min.js"></script>

...
public class LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		// session 저장
		DoctorVO loginUser = user.getDoctorVO();
	...
	private void loginUserlogFile(DoctorVO loginUser, HttpServletRequest request) throws IOException {
		 // 로그인 정보를 스트링으로 저장....
	      String tag = "[login:user]";
	      String log = tag + loginUser.getdId() + ","
	                   + loginUser.getTel() + ","
	                   + loginUser.getEmail() + ","

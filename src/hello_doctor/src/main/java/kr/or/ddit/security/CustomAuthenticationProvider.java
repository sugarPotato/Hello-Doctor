...
public class CustomAuthenticationProvider implements AuthenticationProvider {
	...
	public void setLoginSearchDoctorService(LoginSearchDoctorService loginSearchDoctorService) {
		this.loginSearchDoctorService = loginSearchDoctorService;
	}
	...
	public Authentication authenticate(Authentication auth) throws AuthenticationException {
		...
		try {
			...
			loginSearchDoctorService.securityLogin(login_id, login_pwd);

			DoctorVO doctor = loginSearchDoctorService.secuDoctor(login_id);
